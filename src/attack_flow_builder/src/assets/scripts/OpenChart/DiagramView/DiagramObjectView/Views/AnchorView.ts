...
export class AnchorView extends Anchor implements ViewObject {
     ...
     */
    private _face: AnchorFace;

    /**
     * The view's face.
     */
    public get face(): AnchorFace {
        return this._face;
    }
     ...
     */
    declare protected _latches: LatchView[];
     ...
     */
    public get latches(): ReadonlyArray<LatchView> {
     ...
     *  The view's new face.
     */
    public replaceFace(face: AnchorFace) {
     ...
     */
    public clone(instance?: string, instanceMap?: Map<string, string>): AnchorView {
        // Create clone
